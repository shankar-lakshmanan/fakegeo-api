...
function MultiPointOrMultiPointWithProperties(withProperties: boolean) {
  const multipoint = turf.multiPoint([[-101.278818, 40.816337], [-99.40157045143154, 39.19210754121596]]);
...
function RandomMultiPointOrRandomMultiPointWithProperties(withProperties: boolean) {
...
function WithinMultiPointOrWithinMultiPointWithProperties(
  ...
  if (withProperties) {
    const pointWithProperties = populateGeoJsonFeatureWithProperties(multipoint);
...
function MultiPointsOrMultiPointsWithProperties(withProperties: boolean) {
  ...
  if (withProperties) {
    const multiPointsWithProperties = populateGeoJsonFeatureCollectionWithProperties(multiPointCollection);
...
export function MultiPoints(): OkResponse {
  ...
  function MultiPointsLimitAndWithinOrMultiPointsLimitAndWithinWithProperties(
    ...
    const { limit, geojsonPolygon, bbox } = body;
      ...
      if (withProperties) {
        const multiPointsWithProperties = populateGeoJsonFeatureCollectionWithProperties(finalMultiPoints);
        return multiPointsWithProperties;
      }
  ...
  export function MultiPointsLimitAndWithin(event: any): APIGatewayProxyResult {
    ...
    try {
      const result = MultiPointsLimitAndWithinOrMultiPointsLimitAndWithinWithProperties(
        body,
        false
      );
      return GetOkResponse(result);
  ...
  function RandomMultiPointsOrRandomMultiPointsWithProperties(withProperties: boolean) {
  ...
  export function RandomMultiPoints(): OkResponse {
    return GetOkResponse(RandomMultiPointsOrRandomMultiPointsWithProperties(false));
  }
  

  export function RandomMultiPointsWithProperties(): OkResponse {
    return GetOkResponse(RandomMultiPointsOrRandomMultiPointsWithProperties(true));
  }
  ...
  function RandomMultiPointsLimitAndWithinOrRandomMultiPointsLimitAndWithinWithProperties(
    ...
    if (withProperties) {
      const pointsWithProperties = populateGeoJsonFeatureCollectionWithProperties(finalMultiPoints);
  ...
  export function RandomMultiPointsLimitAndWithin(event: any): APIGatewayProxyResult {
    ...
    try {
      const result = RandomMultiPointsLimitAndWithinOrRandomMultiPointsLimitAndWithinWithProperties(
        body,
        false
      );
      return GetOkResponse(result);
