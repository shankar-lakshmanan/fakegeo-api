...
export const polygonsRoutes: Record<string, Function> = {
  /**
   * @openapi
   * /polygons:
   *   get:
   ...
   *         description: Internal server error
   */
  "POST /polygons": PolygonsLimitAndWithin,
   ...
   *         description: Internal server error
   */
  "GET /polygons/random": RandomPolygons,
   ...
   *         description: Internal server error
   */
  "POST /polygons/random": RandomPolygonsLimitAndWithin,
};
