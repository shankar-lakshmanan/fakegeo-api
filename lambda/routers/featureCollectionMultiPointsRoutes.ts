...
export const featureCollectionMultiPointsRoutes: Record<string, Function> = {
   ...
   *                   example: Error processing input. An internal error occurred
   */
  "POST /featureCollection/multipoints/properties": MultiPointsLimitAndWithinWithProperties,
   ...
   *                   example: Internal Server Error
   */
  "GET /featureCollection/multipoints/random/properties": RandomMultiPointsWithProperties,
 ...
 *                   example: Error processing input. An internal error occurred
 */
"POST /featureCollection/multipoints/random/properties": RandomMultiPointsLimitAndWithinWithProperties,
