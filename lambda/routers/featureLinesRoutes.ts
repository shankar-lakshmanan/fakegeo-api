import {
  ...
  export const featureLinesRoutes: Record<string, Function> = {
  /**
   * @openapi
   * /feature/lines:
   *   get:
   ...
   */
    ...
    "POST /feature/lines": LinesLimitAndWithin,
  
  
  /**
   * @openapi
   * /feature/lines/random:
   *   get:
   *     tags:
   *       - Lines features
  ...
  "GET /feature/lines/random": RandomLines,
  ...
  "POST /feature/lines/random": RandomLinesLimitAndWithin,
  };
